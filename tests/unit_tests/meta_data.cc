...
Json::Value Meta_Data::constuct_image(bool add_operation, Json::Value operations){
    ...
    image["constraints"] ["Name"][0] = "==";
    image["constraints"] ["Name"][1] = "sample-image";  
    image["_ref"]=1;
    result["list"][0] = "Name";
...
Json::Value Meta_Data::construct_add_connection(int ref1, int ref2, bool const_on){
...
Json::Value Meta_Data::construct_find_entity(bool auto_delete=false, bool expiration=false){
