...
// pod_creator method will help populate the fields required to create a pod
// within the cluster with a PodNAme in the argument service_creator method will
// help populate fields specific to crearion of a service with the AppSelector
// and ServiceName in the arguments
class KubeHelper {
 public:
