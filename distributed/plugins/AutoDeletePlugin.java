   ...
   public AutoDeletePlugin()
   {
      ...
      for(int i = 0; i < sourceNodeCount; i++)
      {
         ...
         try 
         {
            ...
            PublisherServiceThread thisServerServivceThread = new AutoPublisherServiceThread(this, thisSocket, threadId, initSequence);
