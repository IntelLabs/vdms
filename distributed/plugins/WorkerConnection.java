...
public class WorkerConnection
{
    ...
    WorkerConnectionList destinationConnections;
    ...
    public void SetDestinations(WorkerConnectionList nDestinationConnections)
    {
	destinationConnections = nDestinationConnections;
    }
