...
only when needed) the size on disk shown for the database by some utilities can be quite
large. Similarly, copying a database can take a long time. So we use a
different method of copying/archiving a VDMS database.
...
[more info here](https://stackoverflow.com/questions/13252682/copying-a-1tb-sparse-file).