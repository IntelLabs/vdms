...
### Examples
    ...
    // To find information about edges from class Visit where its "start" property is on or
    ...
    // Now find the connections that originate from the Visit entities above and
    // have a class #To
    "FindConnection": {
        "ref1": 1,
        "class": "To",
