...
analyze customer behavior, one could imagine entities like Customer, Object,
...
video snippets captured by cameras, and so on. Each of these entities could,
in turn, have their own properties, either known at the start of the
...
in a "Analytics for Retail" use case:
