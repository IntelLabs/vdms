...
class ConnectionQueryParser : public CSVParserUtil{
    ...
    //    VDMS::Response  ParseUpdateConnection(vector<string> row, vector<string> & cols);
};
};

VDMS::Response VDMS::ConnectionQueryParser::ParseAddConnection(vector<string> row, vector<string> & columnNames){
   Json::Value aquery;
   Json::Value allquery;
...
// VDMS::Response VDMS::ConnectionQueryParser::ParseUpdateConnection(vector<string> row, vector<string> & columnNames){
//    Json::Value aquery;
//    Json::Value aqueryf;
//    Json::Value allquery;
//     if(row[0]=="")
