...
class DescriptorQueryParser : public CSVParserUtil{
    public:
       VDMS::Response ParseAddDescriptor(vector<string> row, vector<string>& columnNames, int id);
       
};
};

VDMS::Response VDMS::DescriptorQueryParser::ParseAddDescriptor(vector<string> row, vector<string>& columnNames, int id){
